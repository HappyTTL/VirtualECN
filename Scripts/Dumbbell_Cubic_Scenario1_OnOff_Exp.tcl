...
if {$enableNam != 0} {
	...
	set namfile [open outCubicS1_OnOff_Exp.nam w]
	$ns namtrace-all $namfile
}

set tf [open outCubicS1_OnOff_Exp.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileCubicS1_OnOff_Exp.tr w]
set throughputfile [open thrfileCubicS1_OnOff_Exp.tr w]
proc finish {} {
	...
	if {$enableNam != 0} {
		close $namfile
		exec nam outCubicS1_OnOff_Exp.nam &
	}
	exit 0
}
