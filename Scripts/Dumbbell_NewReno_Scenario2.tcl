...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoS2.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoS2.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoS2.tr w]
set throughputfile [open thrfileNewRenoS2.tr w]
proc finish {} {
