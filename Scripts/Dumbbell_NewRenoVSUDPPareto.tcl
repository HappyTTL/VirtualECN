...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoVSUDP.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoVSUDP.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoVSUDPHalfS1.tr w]
set throughputfile [open thrfileNewRenoVSUDPHalfS1.tr w]
