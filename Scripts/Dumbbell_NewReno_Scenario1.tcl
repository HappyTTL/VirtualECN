...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoS1.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoS1.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoS1.tr w]
set throughputfile [open thrfileNewRenoS1.tr w]
proc finish {} {
