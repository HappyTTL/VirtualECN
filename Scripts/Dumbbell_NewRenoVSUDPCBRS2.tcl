...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoVSUDPCBRS2.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoVSUDPCBRS2.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoVSUDPCBRS2.tr w]
set throughputfile [open thrfileNewRenoVSUDPCBRS2.tr w]
...
proc finish {} {
	...
	if {$enableNam != 0} {
		close $namfile
		exec nam outNewRenoVSUDPCBRS2.nam &
	}
	exit 0
}
