...
if {$enableNam != 0} {
	...
	set namfile [open outCubicS1.nam w]
	$ns namtrace-all $namfile
}

set tf [open outCubicS1.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileCubicS1.tr w]
set throughputfile [open thrfileCubicS1.tr w]
proc finish {} {
