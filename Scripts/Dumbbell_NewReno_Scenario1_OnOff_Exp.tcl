...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoS1_OnOff_Exp.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoS1_OnOff_Exp.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoS1_OnOff_Exp.tr w]
set throughputfile [open thrfileNewRenoS1_OnOff_Exp.tr w]
proc finish {} {
	...
	if {$enableNam != 0} {
		close $namfile
		exec nam outNewRenoS1_OnOff_Exp.nam &
	}
	exit 0
}
...
$ns rtmodel Exponential {0 10 0.01 50.0} $nqueue1 $nqueue2
