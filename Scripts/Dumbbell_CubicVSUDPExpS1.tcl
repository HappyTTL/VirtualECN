...
if {$enableNam != 0} {
	...
	set namfile [open outCubicVSUDPExpS1.nam w]
	$ns namtrace-all $namfile
}

set tf [open outCubicVSUDPExpS1.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileCubicVSUDPExpS1.tr w]
set throughputfile [open thrfileCubicVSUDPExpS1.tr w]
...
proc finish {} {
	...
	if {$enableNam != 0} {
		close $namfile
		exec nam outCubicVSUDPExpS1.nam &
	}
	exit 0
}
