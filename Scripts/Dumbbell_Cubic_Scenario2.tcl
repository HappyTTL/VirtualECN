...
if {$enableNam != 0} {
	...
	set namfile [open outCubicS2.nam w]
	$ns namtrace-all $namfile
}

set tf [open outCubicS2.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileCubicS2.tr w]
set throughputfile [open thrfileCubicS2.tr w]
proc finish {} {
