...
if {$enableNam != 0} {
	...
	set namfile [open outCubicS3.nam w]
	$ns namtrace-all $namfile
}

set tf [open outCubicS3.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileCubicS3.tr w]
set throughputfile [open thrfileCubicS3.tr w]
proc finish {} {
