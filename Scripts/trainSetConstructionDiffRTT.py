...
data3 = pd.read_csv("/Users/tingtinglu/Desktop/Dumbbell_ServerDataProcess/5features_dataSet_NewReno_S2_1.txt", sep = ' ', names = ['send_diff', 'receive_diff', 'send_ewma', 'receive_ewma', 'rtt_ratio', 'ecn'])
data4 = pd.read_csv("/Users/tingtinglu/Desktop/Dumbbell_ServerDataProcess/5features_dataSet_Cubic_S2_1.txt", sep = ' ', names = ['send_diff', 'receive_diff', 'send_ewma', 'receive_ewma', 'rtt_ratio', 'ecn'])
data5 = pd.read_csv("/Users/tingtinglu/Desktop/Dumbbell_ServerDataProcess/5features_dataSet_Cubic_S3_1.txt", sep = ' ', names = ['send_diff', 'receive_diff', 'send_ewma', 'receive_ewma', 'rtt_ratio', 'ecn'])
data6 = pd.read_csv("/Users/tingtinglu/Desktop/Dumbbell_ServerDataProcess/5features_dataSet_NewReno_S3_1.txt", sep = ' ', names = ['send_diff', 'receive_diff', 'send_ewma', 'receive_ewma', 'rtt_ratio', 'ecn'])
