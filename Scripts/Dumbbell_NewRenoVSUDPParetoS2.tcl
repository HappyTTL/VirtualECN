...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoVSUDPParetoS2.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoVSUDPParetoS2.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoVSUDPParetoS2.tr w]
set throughputfile [open thrfileNewRenoVSUDPParetoS2.tr w]
...
proc finish {} {
	...
	if {$enableNam != 0} {
		close $namfile
		exec nam outNewRenoVSUDPParetoS2.nam &
	}
	exit 0
}
