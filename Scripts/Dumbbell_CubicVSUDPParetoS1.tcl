...
if {$enableNam != 0} {
	...
	set namfile [open outCubicVSUDPParetoS1.nam w]
	$ns namtrace-all $namfile
}

set tf [open outCubicVSUDPParetoS1.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileCubicVSUDPParetoS1.tr w]
set throughputfile [open thrfileCubicVSUDPParetoS1.tr w]
...
proc finish {} {
	...
	if {$enableNam != 0} {
		close $namfile
		exec nam outCubicVSUDPParetoS1.nam &
	}
	exit 0
}
