...
if {$enableNam != 0} {
	...
	set namfile [open outNewRenoS3.nam w]
	$ns namtrace-all $namfile
}

set tf [open outNewRenoS3.tr w]
$ns trace-all $tf

set mytracefile [open mytracefileNewRenoS3.tr w]
set throughputfile [open thrfileNewRenoS3.tr w]
proc finish {} {
